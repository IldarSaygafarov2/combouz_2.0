...
!function () {
    var t = {
        56: function () {
            ...
            function o() {
                ...
                function d(t, e, r, n) {
                    var o = e && e.prototype instanceof h ? e : h, i = Object.create(o.prototype), c = new j(n || []);
                ...
                return m.prototype = y, a(w, "constructor", {
                    ...
                    constructor: j, reset: function (t) {
                        if (this.prev = 0, this.next = 0, this.sent = this._sent = void 0, this.done = !1, this.delegate = null, this.method = "next", this.arg = void 0, this.tryEntries.forEach(O), !t) for (var e in this) "t" === e.charAt(0) && i.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = void 0)
                    }, stop: function () {
                        this.done = !0;
    ...
    r.n = function (t) {
        ...
        if (b && _) {
            var q = b.querySelector(".modal__form-signin"), O = b.querySelector(".modal__form-register"),
                j = L(q.querySelectorAll(".modal__form-input")), k = L(O.querySelectorAll(".modal__form-input")),
                A = q.querySelector(".modal__form-btn"), P = O.querySelector(".modal__form-btn"),
                T = O.querySelector(".modal__form-password"), C = O.querySelector(".modal__form-password-rep"),
            ...
            return t = z().mark((function t(e, r, n) {
                ...
                return z().wrap((function (t) {
                    for (; ;) switch (t.prev = t.next) {
                        case 0:
                            return t.next = 3, fetch("".concat("https://combouz.pythonanywhere.com").concat(e), U({method: r}, n));
                        case 3:
                            if (!(o = t.sent).ok) {
                                t.next = 10;
                                break
        ...
        var B = L(document.querySelectorAll(".single__left-item")), J = document.querySelector(".single__left-show"),
            W = null == J ? void 0 : J.querySelector(".single__left-zoom"),
            X = null == J ? void 0 : J.querySelector("img"), $ = function (t, e) {
                return isNaN(Number(t.getAttribute(e))) ? null : Number(t.getAttribute(e))
            };
        X && B && J && W && (B.forEach((function (t) {
            t.addEventListener("mouseenter", (function () {
                var e = t.querySelector("img");
                X.src = e.src, X.style.backgroundImage = e.src, J.setAttribute("data-img", e.src)
            }))
        })), J.addEventListener("mouseover", (function () {
            var t = this.getAttribute("data-img");
            W.classList.add("show"), W.style.backgroundImage = "url(".concat(t, ")")
        })), J.addEventListener("mousemove", (function (t) {
            !function (t, e) {
                var r = t.offsetX, n = t.offsetY, o = r / e.offsetWidth * 100, i = n / e.offsetHeight * 100;
                W.style.backgroundPosition = "".concat(o, "% ").concat(i, "%")
            }(t, this)
